...
%\usepackage{sectsty} % needed to center the abstract...(there should be a better way)

%used to include documents in the apendix (IRB approval)
%\usepackage{pdfpages} %removed since stuff like this counts as oversized matter and cant use this.
...
%\makeatletter
%\renewcommand{\cftchappresnum}{\@chapapp\space} %adds 'Chapter ' to the TOC
%\makeatother
\renewcommand{\cftchapfont}{\mdseries}
\renewcommand{\cftchappagefont}{\mdseries}
\setlength{\cftchapnumwidth}{\widthof{\chaptername~999~}}
\setlength{\cftsecnumwidth}{\widthof{~9.9~}}
\setlength{\cftsubsecnumwidth}{\widthof{~9.9.99~}}
\setlength{\cftsubsubsecnumwidth}{\widthof{~9.9.99.9~}}
...
\g@addto@macro\appendix{%
  \addtocontents{toc}{%
    \protect\renewcommand{\protect\cftchappresnum}{}%
  	\protect\setlength{\cftchapnumwidth}{\widthof{\textbf{~999~}}}
  \protect\cftsetindents{chapter}{0em}{2em}  	
  }%
...
%  \addtocontents{toc}{%
    ...
    %\setlength{\cftsecnumwidth}{\widthof{\textbf{Appendix~9.9~}}}
%  }%
%  \titleformat{\section} {\Large\bfseries}{HELLO \thesection}{1em}{}
...
%\chapterfont{\centering} % % for abstract
...
\phantomsection
\chapter*{\centerline{Acknowledgments}}             % Acknowledgements page
	\begin{center}
