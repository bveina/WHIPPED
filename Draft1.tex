...
\includepdf[pages={1-},scale=.9,offset= 0.1in -0.5in]{Images/IRB_Form.pdf}
\section{Duke Activity Status Index Worksheet}
\includepdf[scale=.8]{Images/DASI_form.pdf}
\section{Heart Failure Somatic Awareness Worksheet}
\includepdf[pages={1-},scale=0.8,landscape,offset= 0.4in -0.65in]{Images/HFSA_Form.pdf}
