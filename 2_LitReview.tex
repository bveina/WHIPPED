...
While ZigBee meets the minimum bandwidth requirement, as shown in \cref{WirelessComparison}, and uses less power, Shannon concludes the lack of smart phone hardware support makes Bluetooth a better option presently. If phones begin supporting the ZigBee protocol a switch could be made, in the future.  ZigBee could be a viable protocol in the future as shown by Peligris; who examines the IEEE802.15.4\cite{IEEE802.15.42011}, the protocol underlying ZigBee \cite{Pelegris2011}.
