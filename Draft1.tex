...
\title{Wireless Health Indicator Patch  for Patient Education and Diagnostics (WHIPPED): \protect\\ An Integrated System Approach to Patient Self-Care}
...
\firstreader{Honggang Wang}{Associate Professor, Department of Computer Engineering}{Dissertation Committee}
\secondreader{Liudong Xing}{Professor, Department of Computer Engineering}{Dissertation Committee}
\thirdreader{Kristen Sethares}{Professor, Department of Nursing}{Dissertation Committee}

\fourthreader{Janet Prichard}{Professor, Computer Information Systems Bryant University, Rhode Island}{Dissertation Committee}
...
%\newgeometry{letterpaper,top=1.0in, bottom=1.125in,left=1.675in, right=1.0in, includehead}
\signaturepage
%\restoregeometry
...
\cftaddtitleline{toc}{chapter}{CD Poclet with Source Code}{Back Cover}
